...
const SignUp = () => {
  ...
  const SignUpSubmit = (e) => {
      ...
      if(fname === "" || lname === "" || email === "" || password === ""){
        toast.error("All fields should be non-empty");
      }
      else{
        axios.post("http://localhost:8080/register/adduser", {firstName: fname, lastName: lname, email: email, password: password}).then(res => {
      ...
      <div class="container">
        ...
        <div class="form">
          ...
          <div class="sign-up" id="sign-up-info">
            ...
            <form id="sign-up-form" onSubmit={SignUpSubmit}>
